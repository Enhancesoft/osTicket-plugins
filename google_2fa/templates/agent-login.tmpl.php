...
<div id="loginBox">
    ...
    <h1 id="logo"><a href="index.php">
        ...
        <img src="logo.php?login" alt="SupportSystem :: <?php echo __('Staff Control Panel');?>" />
    </a></h1>
    <h3><?php echo Format::htmlchars($msg); ?></h3>

    <form action="google2fa.php" method="post">
        <?php csrf_token(); ?>
        <fieldset>
            <input type="text" name="code" id="code" value="<?php echo
                $info['userid']; ?>" placeholder="<?php echo __('Google Authenticator Passcode'); ?>"
    ...
    <div id="poweredBy"><?php echo __('Powered by'); ?>
        <a href="https://www.osticket.com" target="_blank">
